...
%
pesquisa_h(Problema, Algoritmo, Heuristica/*, Solucao, Stat*/) :-
    consult(Problema),    % estado_inicial, estado_final, tr
    consult(Heuristica),  % heuristica
    estado_inicial(E0),
    pesquisa_h(Algoritmo, [no(E0, nenhum, nenhum, 0, 1, 0)], Solucao, Stat),
...
%
pesquisa_h(aestrela, Estado, Solucao, Stat) :-
    p_aestrela(Estado, Solucao, Stat).

pesquisa_h(ansiosa, Estado, Solucao, Stat) :-
    p_ansiosa(Estado, Solucao, Stat).

pesquisa_h(hillclimbing, [ Estado ], Solucao, Stat) :-
